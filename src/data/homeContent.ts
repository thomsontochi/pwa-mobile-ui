...
export const homeShortcuts: HomeShortcut[] = [
  ...
  { id: 6, label: 'My Golden Gift', badgeCount: 0, icon: 'gold-gift' },
  { id: 7, label: 'Papara EDU Card', badgeCount: 0, icon: 'credit-card' },
  { id: 8, label: 'Papara Metal Card', badgeCount: 0, icon: 'credit-card' },
]
...
export const productSlides: ProductSlide[] = [
  {
    ...
    badgeLabel: 'Papara Varlık',
    illustration: 'precious-metals',
    accentColor: '#2A2A2D',
    details: ['Altın, gümüş ve platin hesaplarını tek yerden yönet.'],
    primaryCta: 'Kıymetli Madenler Hesabı Aç',
    secondaryCta: 'Hesap Detayları',
  },
  {
    id: 2,
    eyebrow: 'Borsada İşlem',
    title: 'Yatırım Hesabı',
    subtitle: 'Hisse senedi al / sat',
    cta: 'Yatırım Hesabı Oluştur',
    badgeLabel: 'Borsa İstanbul • NASDAQ',
    illustration: 'investment-account',
    accentColor: '#202024',
    details: ['Global borsalarda komisyonsuz işlem yap.'],
    primaryCta: 'Yatırım Hesabı Oluştur',
    secondaryCta: 'Piyasa Verileri',
  },
  {
    id: 3,
    eyebrow: 'Döviz İşlemleri',
    title: 'Dolar Hesabı',
    subtitle: 'Yatırım işlemlerin için dolar al / sat.',
    cta: 'Yatırım Hesabı Oluştur',
    badgeLabel: 'USD • Papara',
    illustration: 'dollar-account',
    accentColor: '#1F1F23',
    details: ['Kur avantajlarıyla anında dolar al / sat.'],
    primaryCta: 'Yatırım Hesabı Oluştur',
  },
  {
    id: 4,
...
export const quickActions: QuickAction[] = [
  ...
  { id: 5, label: 'Ödemeler Özeti', icon: 'wallet', route: '/payments/summary' },
]
...
export const bottomNavItems: BottomNavItem[] = [
  ...
  { id: 4, label: 'Ödemeler', icon: 'wallet', route: '/payments/summary' },
